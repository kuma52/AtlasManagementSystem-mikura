  ...
  <div class="top_area w-75 m-auto pt-5">
    ...
    <div class="user_status p-3 shadow">
      ...
      <div class="subject_edit_area">
        @can('admin')
        <span class="subject_edit_btn">選択科目の編集<span class="arrow"></span></span>
        <div class="subject_inner">
          <form action="{{ route('user.edit') }}" method="post">
            <div class="d-flex mb-2">
              @foreach($subject_lists as $subject_list)
                <label class="ml-3 mr-1 mb-0 mt-2">{{ $subject_list->subject }}</label>
                <input class="pointer" type="checkbox" name="subjects[]" value="{{ $subject_list->id }}">
              @endforeach
                <div class="ml-4">
